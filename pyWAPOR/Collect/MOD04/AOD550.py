import sys
from pyWAPOR.Collect.MOD04.DataAccess import DownloadData

def main(Dir, Startdate, Enddate, latlim, lonlim, username, password, Waitbar = 1, hdf_library = None, remove_hdf = 1):

    """
    This function downloads MOD04 daily data for the specified time
    ...
    """
    print('\nDownload daily MODIS AOD550 data for period %s till %s' %(Startdate, Enddate))
