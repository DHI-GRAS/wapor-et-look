...
def main(Dir, Vars, Startdate, Enddate, latlim, lonlim, username = '', password = '', Waitbar = 1):
    """
    ...
    for Var in Vars:
        ...
        # Download data
        DownloadData(Dir, Var, Startdate, Enddate, latlim, lonlim, "daily_MERRA2", '', username, password, Waitbar = 1)
